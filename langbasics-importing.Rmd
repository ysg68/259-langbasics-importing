...
`r chunk_reveal("import_multiple", break_type = "auto", widths = c(2, 1))`
...
- Tibbles are the tidyverse equivalent of base R data frames. I use the terms interchangeably. 
...
- Unlike in Excel/SPSS, you cannot edit the values. This is a feature, not a bug!
...
- Our working directory is `/Users/johnfranchak/Documents/GitHub-259-2022/259-langbasics-importing`
...
`r chunk_reveal("tibble", break_type = "auto", widths = c(2, 1))`
