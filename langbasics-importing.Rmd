...
# But those calculations aren't useful unless we put the results somewhere to use and modify
...
# After removing two, calling it again would lead to an error because it doesn't exist
rm(two)
...
# We call functions by writing their name followed by a list of  
